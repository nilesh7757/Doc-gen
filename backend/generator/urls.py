...
from .views import chat, download_pdf, conversation_list, conversation_detail, download_latest_conversation_pdf, upload_signature, get_version_content, download_version_pdf
